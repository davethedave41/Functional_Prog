module W1 where
    ...
    smallestDivisor n  = smallestDiv 2 n
    
    smallestDiv :: Integer -> Integer -> Integer
    smallestDiv d n = case(mod n d) of
                        0         -> d
                        otherwise -> smallestDiv (d+1) n 
